...
4. Breaking about a monolith site and database into boundaries, not all at once, little by little
5. Compose micro front-ends into a homogenous site with BFFs and web-components
6. Break down buildtime dependencies between teams by embracing runtime dependencies
7. Implement anti-corruption layers between boundaries (both internal and exterinal)
...
3. Zero bug policy
4. Breaking work down in to small, managable, incremental parts
5. Improving the SDLC process and integrating it into automation.
6. Integrating SOC and EDE audit requiremnts into the SDLC process without constricting incremental improvements
7. Shifting left with QA engineers, product managers and UX designers.
